...
public class WakeCommand : ICommand
{
    ...
    private async Task ShowOptions(TelnetSession session, World world, Entity player)
    {
        ...
        {
            case "Crom":
                message = "The spirit of Crom laughs at your weakness. 'Valhalla is not yet for you,' he booms. \n" +
                          "A spectral warrior extends a hand. 'Pay the toll of gold, or rot here until your strength returns.'";
                break;
            case "The Light":
                message = "A warm glow surrounds you. A soft voice whispers, 'Child, your work is not done.' \n" +
                          "You feel you could give an offering to return now, or rest in the light to recover.";
                break;
            default:
                message = "You float in a dark void. A hooded figure approaches silently. \n" +
    ...
    {
        int cost = 10;
        ref var money = ref world.Get<MoneyComponent>(player);
